<!--
Template found on https://freefrontend.com/html-css-404-page-templates/
Author : Saleh Riaz Qureshi, 23/04/2018
Modified and adapted by : Tristan Lieberherr, 15/07/2021
-->
<template>
  <!--
...
.bg-purple {
  ...
  background: url(/src/assets/img/404/bg_purple.png) repeat-x left top;
  height: 100%;
  overflow: hidden;
}
...
.stars {
  ...
  background: url(/src/assets/img/404/overlay_stars.svg) repeat left top;
}
